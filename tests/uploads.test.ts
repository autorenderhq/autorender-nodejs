import fs from 'fs';
import type { ResponseLike } from '@autorender/sdk/internal/to-file';
import { toFile } from '@autorender/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@autorender/sdk/core/uploads');
    await expect(
