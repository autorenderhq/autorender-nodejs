import fs from 'fs';
import type { ResponseLike } from '@autorender/nodejs/internal/to-file';
import { toFile } from '@autorender/nodejs/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@autorender/nodejs/core/uploads');
    await expect(
