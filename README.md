...
[![NPM version](<https://img.shields.io/npm/v/autorender.svg?label=npm%20(stable)>)](https://npmjs.org/package/autorender) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/autorender)
...
```ts
import fs from 'fs';
import Autorender, { toFile } from 'autorender';
...
```ts
import Autorender from 'npm:autorender';
...
We are keen for your feedback; please open an [issue](https://www.github.com/autorenderhq/autorender-node/issues) with questions, bugs, or suggestions.
