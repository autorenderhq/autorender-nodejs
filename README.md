...
[![NPM version](<https://img.shields.io/npm/v/@autorender/sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@autorender/sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@autorender/sdk)
...
```ts
import Autorender from 'npm:@autorender/sdk';
